...
class Symbolicator:
    ...
    def symbolicate_same_crashes(self, crash_list: enumerate[dict], crash_dir: str, symbolicate_crashes: list[str]):
        ...
        final_crash = crash_parser.read_crash(crash_dir_obj / result_filename, False)
